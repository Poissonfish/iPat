...
class PanelGAPIT extends PanelTool {
    ...
    public PanelGAPIT(GUI_Models.PanelCov cov) {
        // Basic features
...
class PanelFarmCPU extends PanelTool {
    ...
    public PanelFarmCPU(GUI_Models.PanelCov cov) {
        // Basic features
...
class PanelPlink extends PanelTool {
    ...
    public PanelPlink(GUI_Models.PanelCov cov) {
        // Basic features
        basic = new JPanel(new MigLayout("fillx"));
...
class PanelgBLUP extends PanelTool {
    ...
    public PanelgBLUP(GUI_Models.PanelCov cov) {
        // Adv features
...
class PanelrrBLUP extends PanelTool {
    ...
    public PanelrrBLUP(GUI_Models.PanelCov cov) {
        // Basic features
...
class PanelBGLR extends PanelTool  {
    ...
    public PanelBGLR(GUI_Models.PanelCov cov) {
        // Basic features
